...
/**
 * Created by ${sheldon} on 2017/1/11.
 */
public class OkHttpClientUtils {
    ...
    private OkHttpClientUtils() {
        ...
        // 设置超时时间30s
        mOkHttpClient.setConnectTimeout(30 * 1000, TimeUnit.MILLISECONDS);
        // 获取handle
     ...
     * @return
     */
    private Request buildPostFormRequest(String url, List<Param> params,
                                         Object tag) {
        if (params == null) {
    ...
    public class PostDelegate {
         ...
         * @throws IOException
         */
        public String postGetString(String url, Param[] params)
                throws IOException {
            return postGetString(url, params, null);
        }
         ...
         * @throws IOException
         */
        public String postGetString(String url, Param[] params, Object tag)
                throws IOException {
        ...
        @SuppressWarnings("rawtypes")
        public void postAsyn(String url, List<Param> params,
                             final ResultCallback callback) {
